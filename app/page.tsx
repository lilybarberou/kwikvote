...
export default function Home() {
  ...
  return (
    <div className="w-full flex flex-col items-center">
        ...
        >
          <div className="border border-[#ffffff38] border-b-0 rounded-sm">
            ...
            <TabsContent value="waitlist" className="mt-0 pt-3 bg-background">
              <Image className="w-full h-full object-cover rounded-sm" width={1000} height={500} src="/poll-2.png" alt="Sondage avec liste d'attente" />
            </TabsContent>
          </div>
        </motion.div>
      </Tabs>
      ...
      <p className="mb-8 text-muted-foreground text-center">Si vous avez lié vos sondages à votre adresse mail, vous pourrez en retrouver un historique.</p>
