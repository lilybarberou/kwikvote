...
export const ConsultedHistory = () => {
  ...
  return (
    <div className="flex w-full min-w-[200px] flex-col rounded bg-popover dark:bg-transparent">
          ...
          <Link
            className={`relative overflow-hidden text-ellipsis px-3 py-2 text-sm ${
              index === pollHistory.length - 1
                ? ""
                : "after:absolute after:bottom-0 after:left-3 after:h-1 after:w-[calc(100%-24px)] after:border-b after:border-[#41414121] dark:after:border-[#ffffff29]"
            }`}
